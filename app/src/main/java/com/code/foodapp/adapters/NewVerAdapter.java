...
public class NewVerAdapter extends RecyclerView.Adapter<NewVerAdapter.ViewHolder> {
    ...
    public NewVerAdapter(List<ProductModel> list, Activity activity, Context context) {
        this.list = list;
    ...
    @NonNull
    @Override
    public NewVerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.favourite_ver_item, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull NewVerAdapter.ViewHolder holder, int position) {
