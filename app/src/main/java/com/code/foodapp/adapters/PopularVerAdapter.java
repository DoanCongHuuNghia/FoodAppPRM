...
public class PopularVerAdapter extends RecyclerView.Adapter<PopularVerAdapter.ViewHolder> {
    ...
    public PopularVerAdapter(List<ProductModel> list, Activity activity, Context context) {
        this.list = list;
    ...
    @NonNull
    @Override
    public PopularVerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.favourite_ver_item, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull PopularVerAdapter.ViewHolder holder, int position) {
